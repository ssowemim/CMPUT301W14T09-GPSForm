 ...
 * LocationController is responsible for getting geolocation when it is requested. It can setup a location
...
public class LocationController {
	...
	/**
	 * requestLocationUpdates requests a location update using the 
	 * location manager and a location listener from activity
	 */
	...
	/**
	 * locationchanged is responsible for getting location points from GPS location on android activity
	...
	/**
	 * updatelocation is responsible for updating the geolocation points in locationcontroller
