...
public class PopUpComment extends PopUp {
    ...
    public interface PopUpUser{
        public void popUpResult(int requestCode, int resultCode, Intent data);
    ...
    //@SuppressLint("NewApi")
    public void popUp(View v, final Activity caller, final Uri fileUri, final LocationController lc1, final GeoLocation selectedgeo, final User user) {
